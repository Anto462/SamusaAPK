                          ...
                          child: Align(
                            ...
                            child: Padding(
                              ...
                              child: ClipRRect(
                                ...
                                child: Image.asset(
                                  'assets/images/Imagenes-top-02.png',
                          ...
                          child: Container(
                            ...
                            decoration: BoxDecoration(
                              gradient: const LinearGradient(
                                colors: [Color(0x680533B0), Color(0x40FFFFFF)],
                                stops: [0.0, 1.0],
                                        ...
                                        child: Padding(
                                          ...
                                          child: StreamBuilder<
                                            ...
                                            builder: (context, snapshot) {
                                              ...
                                              List<ImportacionesRecord>
                                                  containerImportacionesRecordList =
                                                  snapshot.data!;
                                              // Return an empty Container when the item does not exist.
                                              if (snapshot.data!.isEmpty) {
                                                return Container();
                                              }
                                              final containerImportacionesRecord =
                                                  containerImportacionesRecordList
                                                          .isNotEmpty
                                                      ? containerImportacionesRecordList
                                                          .first
                                        ...
                                        child: Padding(
                                          ...
                                          child: StreamBuilder<
                                            ...
                                            builder: (context, snapshot) {
                                              ...
                                              List<ExportacionesRecord>
                                                  containerExportacionesRecordList =
                                                  snapshot.data!;
                                              // Return an empty Container when the item does not exist.
                                              if (snapshot.data!.isEmpty) {
                                                return Container();
                                              }
                                              final containerExportacionesRecord =
                                                  containerExportacionesRecordList
                                                          .isNotEmpty
                                                      ? containerExportacionesRecordList
                                                          .first
                              ...
                              child: Align(
                                ...
                                child: Container(
                                  ...
                                  child: InkWell(
                                    ...
                                    child: Lottie.asset(
                                      'assets/lottie_animations/water.json',
                                ...
                                'transformOnPageLoadAnimation5']!),
                            Transform.rotate(
                              angle: 27.0 * (math.pi / 180),
                              alignment: const AlignmentDirectional(-1.0, 1.0),
                              origin: const Offset(-40.0, -100.0),
                              child: Align(
                                alignment: const AlignmentDirectional(-1.0, 1.0),
                                child: Container(
                                ...
                                'transformOnPageLoadAnimation6']!),
                            Align(
                              alignment: const AlignmentDirectional(1.0, 1.0),
                              child: Transform.rotate(
                                angle: 143.0 * (math.pi / 180),
                                alignment: const AlignmentDirectional(1.0, 1.0),
                                origin: const Offset(-66.0, -20.0),
                                child: Align(
                                  alignment: const AlignmentDirectional(1.0, 1.0),
                                  child: Container(
                                    width:
