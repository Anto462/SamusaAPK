...
class ExportacionesRecord extends FirestoreRecord {
  ExportacionesRecord._(
    super.reference,
    super.data,
  ) {
    _initializeFields();
  ...
  static CollectionReference get collection =>
      FirebaseFirestore.instance.collection('Exportaciones');

  static Stream<ExportacionesRecord> getDocument(DocumentReference ref) =>
      ref.snapshots().map((s) => ExportacionesRecord.fromSnapshot(s));

  static Future<ExportacionesRecord> getDocumentOnce(DocumentReference ref) =>
      ref.get().then((s) => ExportacionesRecord.fromSnapshot(s));

  static ExportacionesRecord fromSnapshot(DocumentSnapshot snapshot) =>
      ExportacionesRecord._(
        snapshot.reference,
        mapFromFirestore(snapshot.data() as Map<String, dynamic>),
      );

  static ExportacionesRecord getDocumentFromData(
    Map<String, dynamic> data,
    DocumentReference reference,
  ) =>
      ExportacionesRecord._(reference, mapFromFirestore(data));

  @override
  String toString() =>
      'ExportacionesRecord(reference: ${reference.path}, data: $snapshotData)';
  ...
  @override
  bool operator ==(other) =>
      other is ExportacionesRecord &&
      reference.path.hashCode == other.reference.path.hashCode;
}

Map<String, dynamic> createExportacionesRecordData({
...
class ExportacionesRecordDocumentEquality
    implements Equality<ExportacionesRecord> {
  const ExportacionesRecordDocumentEquality();

  @override
  bool equals(ExportacionesRecord? e1, ExportacionesRecord? e2) {
  ...
  @override
  int hash(ExportacionesRecord? e) => const ListEquality().hash([
  ...
  @override
  bool isValidKey(Object? o) => o is ExportacionesRecord;
}
