...
import 'eliminar_cotizacion_model.dart';
export 'eliminar_cotizacion_model.dart';

class EliminarCotizacionWidget extends StatefulWidget {
  const EliminarCotizacionWidget({super.key});

  @override
  State<EliminarCotizacionWidget> createState() =>
      _EliminarCotizacionWidgetState();
}

class _EliminarCotizacionWidgetState extends State<EliminarCotizacionWidget> {
  late EliminarCotizacionModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => EliminarCotizacionModel());
  }
                    ...
                    StreamBuilder<List<ProductosRecord>>(
                      stream: queryProductosRecord(
                        queryBuilder: (productosRecord) =>
                            productosRecord.orderBy('categoria'),
                      ),
                          ...
                          itemBuilder: (context, listViewIndex) {
                            ...
                            return Slidable(
                                          ...
                                          await showDialog<bool>(
                                                ...
                                                builder: (alertDialogContext) {
                                                  return AlertDialog(
                                                    ...
                                                    content: Text(
                                                        'Deseas borrar ${listViewProductosRecord.nombre}? '),
                                                    actions: [
                                                      TextButton(
                                                        onPressed: () =>
                                                            Navigator.pop(
                              ...
                              child: ListTile(
                                ...
                                subtitle: Text(
                                  listViewProductosRecord.porcentajeImpuesto
                                      .toString(),
                                  style: FlutterFlowTheme.of(context)
                                      .labelMedium
                                      .override(
