...
import 'info_comp_vehicle_exp_model.dart';
export 'info_comp_vehicle_exp_model.dart';

class InfoCompVehicleExpWidget extends StatefulWidget {
  const InfoCompVehicleExpWidget({
    super.key,
    required this.tramiteData,
  });

  final ExportacionesRecord? tramiteData;

  @override
  State<InfoCompVehicleExpWidget> createState() =>
      _InfoCompVehicleExpWidgetState();
}

class _InfoCompVehicleExpWidgetState extends State<InfoCompVehicleExpWidget> {
  late InfoCompVehicleExpModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => InfoCompVehicleExpModel());
  }
