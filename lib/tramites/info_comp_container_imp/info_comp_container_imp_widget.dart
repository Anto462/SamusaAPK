...
import 'info_comp_container_imp_model.dart';
export 'info_comp_container_imp_model.dart';

class InfoCompContainerImpWidget extends StatefulWidget {
  const InfoCompContainerImpWidget({
    super.key,
    required this.tramiteDataC,
  });

  final ImportacionesRecord? tramiteDataC;

  @override
  State<InfoCompContainerImpWidget> createState() =>
      _InfoCompContainerImpWidgetState();
}

class _InfoCompContainerImpWidgetState
    extends State<InfoCompContainerImpWidget> {
  late InfoCompContainerImpModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => InfoCompContainerImpModel());
  }
