...
import 'edita_importacion_c_t_model.dart';
export 'edita_importacion_c_t_model.dart';

class EditaImportacionCTWidget extends StatefulWidget {
  const EditaImportacionCTWidget({
    super.key,
  ...
  @override
  State<EditaImportacionCTWidget> createState() =>
      _EditaImportacionCTWidgetState();
}

class _EditaImportacionCTWidgetState extends State<EditaImportacionCTWidget> {
  late EditaImportacionCTModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => EditaImportacionCTModel());
    ...
    _model.txtnavieraTextController ??=
        TextEditingController(text: widget.dataimp?.naviera);
    _model.txtnavieraFocusNode ??= FocusNode();

    _model.txttransportistaTextController ??=
        TextEditingController(text: widget.dataimp?.transportista);
                      ...
                      children: [
                        FFButtonWidget(
                          onPressed: () async {
                            ...
                            if (confirmDialogResponse) {
                              if (widget.dataimp?.estado == 'Completado') {
                                await widget.dataimp!.reference
                                  ...
                                  estadoDekra: widget.dataimp?.estadoDekra,
                                  ...
                                  vin: widget.dataimp?.vin,
                                  marca: widget.dataimp?.marca,
                                  modelo: widget.dataimp?.modelo,
                                  extras: widget.dataimp?.extras,
                                  anio: widget.dataimp?.anio,
                                  correoCliente:
                            ...
                            await launchUrl(Uri(
                                scheme: 'mailto',
                                path: widget.dataimp!.correoCliente,
                                query: {
                                  'subject':
                                      'Actualización de tramite: ${widget.dataimp?.numeroDeSeguimiento}',
                                  'body':
