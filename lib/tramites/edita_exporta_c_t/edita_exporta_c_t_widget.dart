...
import 'edita_exporta_c_t_model.dart';
export 'edita_exporta_c_t_model.dart';

class EditaExportaCTWidget extends StatefulWidget {
  const EditaExportaCTWidget({
    super.key,
    required this.dataex,
  });

  final ExportacionesRecord? dataex;

  @override
  State<EditaExportaCTWidget> createState() => _EditaExportaCTWidgetState();
}

class _EditaExportaCTWidgetState extends State<EditaExportaCTWidget> {
  late EditaExportaCTModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => EditaExportaCTModel());

    _model.txtclienteTextController ??=
        TextEditingController(text: widget.dataex?.correoCliente);
    _model.txtclienteFocusNode ??= FocusNode();

    _model.txtPorigenTextController ??=
        TextEditingController(text: widget.dataex?.puertoOrigen);
    _model.txtPorigenFocusNode ??= FocusNode();

    _model.txtOdestinoTextController ??=
        TextEditingController(text: widget.dataex?.puertoDestino);
    _model.txtOdestinoFocusNode ??= FocusNode();

    _model.txtnavieraTextController ??=
        TextEditingController(text: widget.dataex?.naviera);
    _model.txtnavieraFocusNode ??= FocusNode();

    _model.txttransportistaTextController ??=
        TextEditingController(text: widget.dataex?.transportista);
                        ...
                        child: Align(
                          ...
                          child: Text(
                            valueOrDefault<String>(
                              widget.dataex?.numeroDeSeguimiento,
                              '0',
                            ),
                          ...
                          child: Padding(
                            ...
                            child: FlutterFlowDropDown<String>(
                              controller: _model.estadoDDValueController ??=
                                ...
                                _model.estadoDDValue ??= widget.dataex?.estado,
                              ),
                        ...
                        FFButtonWidget(
                          onPressed: () async {
                            ...
                            if (confirmDialogResponse) {
                              if (widget.dataex?.estado == 'Completado') {
                                await widget.dataex!.reference
                                    .update(createExportacionesRecordData(
                                  numeroDeSeguimiento:
                                      widget.dataex?.numeroDeSeguimiento,
                                  estado: _model.estadoDDValue,
                                  fechaInicio: widget.dataex?.fechaInicio,
                                  fechaEsperada: widget.dataex?.fechaEsperada,
                                  ...
                                  vin: widget.dataex?.vin,
                                  marca: widget.dataex?.marca,
                                  modelo: widget.dataex?.modelo,
                                  extras: widget.dataex?.extras,
                                  anio: widget.dataex?.anio,
                                  correoCliente:
                                ...
                                await widget.dataex!.reference
                                  ...
                                  fechaInicio: widget.dataex?.fechaInicio,
                                  fechaEsperada: widget.dataex?.fechaEsperada,
                                  fechaFin: widget.dataex?.fechaFin,
                                  puertoOrigen:
                                      _model.txtPorigenTextController.text,
                                  puertoDestino:
                                      _model.txtOdestinoTextController.text,
                            ...
                            await launchUrl(Uri(
                                scheme: 'mailto',
                                path: widget.dataex!.correoCliente,
                                query: {
                                  'subject':
                                      'Actualización de tramite: ${widget.dataex?.numeroDeSeguimiento}',
                                  'body':
                                      'Estimado cliente, Comentarle que se cuenta con una actualización de su tramite #${widget.dataex?.numeroDeSeguimiento}El estado del mismo ha cambiado a ${widget.dataex?.estado} puedes obtener mas detalles desde nuestra aplicación.  ',
                                }
                                    .entries
