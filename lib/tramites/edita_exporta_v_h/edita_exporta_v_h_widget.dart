...
import 'edita_exporta_v_h_model.dart';
export 'edita_exporta_v_h_model.dart';

class EditaExportaVHWidget extends StatefulWidget {
  const EditaExportaVHWidget({
    super.key,
    required this.dataexp,
  });

  final ExportacionesRecord? dataexp;

  @override
  State<EditaExportaVHWidget> createState() => _EditaExportaVHWidgetState();
}

class _EditaExportaVHWidgetState extends State<EditaExportaVHWidget> {
  late EditaExportaVHModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => EditaExportaVHModel());
                        ...
                        Expanded(
                          child: Padding(
                            ...
                            child: TextFormField(
                              ...
                              validator: _model
                                  .txtNavieraTextControllerValidator
                                  .asValidator(context),
                            ),
                          ),
                        ),
                      ...
                      children: [
                        FFButtonWidget(
                          onPressed: () async {
                            ...
                            await launchUrl(Uri(
                                scheme: 'mailto',
                                path: widget.dataexp!.correoCliente,
                                query: {
                                  'subject':
                                      'Actualización de tramite: ${widget.dataexp?.numeroDeSeguimiento}',
                                  'body':
                                      'Estimado cliente, Comentarle que se cuenta con una actualización de su tramite #${widget.dataexp?.numeroDeSeguimiento}El estado del mismo ha cambiado a ${widget.dataexp?.estado} puedes obtener mas detalles desde nuestra aplicación.  ',
                                }
                                    .entries
