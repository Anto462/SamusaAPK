...
import '/perfil/edit_perfil/edit_perfil_widget.dart';
    ...
    return GestureDetector(
      ...
      child: Scaffold(
        ...
        body: Stack(
          children: [
            Transform.rotate(
              angle: 151.0 * (math.pi / 180),
              origin: const Offset(-30.0, -18.0),
              child: Container(
            ...
            Transform.rotate(
              angle: 151.0 * (math.pi / 180),
              origin: const Offset(-100.0, -58.0),
              child: Container(
                width: MediaQuery.sizeOf(context).width * 1.0,
                height: 100.0,
                decoration: BoxDecoration(
                ...
                children: [
                          ...
                          var confirmDialogResponse = await showDialog<bool>(
                                ...
                                builder: (alertDialogContext) {
                                  return AlertDialog(
                                    ...
                                    content: const Text('¿Deseas agregar la imagen?'),
                                    actions: [
                                      TextButton(
                          ...
                          if (confirmDialogResponse) {
                            ...
                            await showDialog(
                              ...
                              builder: (alertDialogContext) {
                                return AlertDialog(
                                  title: const Text('Alerta'),
                                  content: const Text('No se actualizo la foto.'),
                                  actions: [
                                    TextButton(
                                      onPressed: () =>
                  ...
                  Row(
                    ...
                    children: [
                      Padding(
                        padding:
                            const EdgeInsetsDirectional.fromSTEB(0.0, 12.0, 2.0, 0.0),
                        child: Icon(
                          Icons.person,
                  ...
                  Row(
                    ...
                    children: [
                      ...
                      AuthUserStreamWidget(
                        builder: (context) => Text(
                          dateTimeFormat(
                              "relative", currentUserDocument!.createdTime!),
                          style:
                        ...
                        Column(
                          ...
                          children: [
                            ...
                            Container(
                              ...
                              child: Lottie.asset(
                                'assets/lottie_animations/bubbles.json',
                                width: 150.0,
                                height: 130.0,
                                fit: BoxFit.cover,
                                animate: true,
