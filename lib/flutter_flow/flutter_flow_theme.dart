...
class LightModeTheme extends FlutterFlowTheme {
  ...
  late Color primary = const Color(0xFF0533B0);
  late Color secondary = const Color(0xFF68F5F8);
  late Color tertiary = const Color(0xFF125EBD);
  late Color alternate = const Color(0xFFB41C20);
  late Color primaryText = const Color(0xFF616064);
  late Color secondaryText = const Color(0xFFB1CDDC);
